            ...
            <div class="card">
                <div class="card-header">
                    <div class="card-tools">
                        <form id="search-form" method="GET" action="{{ route('categories.index') }}">
                    ...
                    <table class="table table-hover text-nowrap">
                        ...
                        @forelse ($categories as $category)
                            <tr id="category-row-{{ $category->id }}">
                                ...
                                <td>
                                    <a href="{{ route('categories.edit', $category->id) }}" class="text-primary edit-category" data-id="{{ $category->id }}">
                                    ...
                                    <a href="#" class="text-danger delete-category" data-id="{{ $category->id }}">
                                        <svg class="w-4 h-4 mr-1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#reset-button').on('click', function() {
                ...
                window.location.href = "{{ route('categories.index') }}"; // Redirect to the same page without query
            });
        });
    </script>
@endsection
