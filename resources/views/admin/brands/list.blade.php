            ...
            <div class="card">
                <div class="card-header">
                    <div class="card-tools">
                        <form id="search-form" method="GET" action="{{ route('brands.index') }}">
                    ...
                    <table class="table table-hover text-nowrap">
                        ...
                        @forelse ($brands as $brand)
                            <tr id="brand-row-{{ $brand->id }}">
                                ...
                                <td>
                                    <a href="{{ route('brands.edit', $brand->id) }}" class="text-primary edit-brand" data-id="{{ $brand->id }}">
                                    ...
                                    <a href="#" class="text-danger delete-brand" data-id="{{ $brand->id }}">
                                        <svg class="w-4 h-4 mr-1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#reset-button').on('click', function() {
                ...
                window.location.href = "{{ route('brands.index') }}"; // Redirect to the same page without query
            });
        });
    </script>
@endsection
